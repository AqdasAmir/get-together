...
-- CreateIndex
CREATE INDEX "idx_attendances_event" ON "event_attendances"("event_id", "responded_at" DESC);

-- CreateIndex
CREATE UNIQUE INDEX "event_attendances_event_id_email_normalized_key" ON "event_attendances"("event_id", "email_normalized");
...
-- AddForeignKey
ALTER TABLE "event_attendances" ADD CONSTRAINT "event_attendances_invite_id_fkey" FOREIGN KEY ("invite_id") REFERENCES "event_invites"("id") ON DELETE SET NULL ON UPDATE CASCADE;
